...
## Exact versus authored

### Exact after the preserved v2 selector

- 101 selected root labels and their exact adjacency;
...
### Authored but reproducible

- selector-order cyclic shift `R_101`;
- choice to promote the optional v2 product extension into v3;
- event starting state `(0,0)`;
